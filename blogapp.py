...
class RegisterForm(Form):
    ...
    password = PasswordField("Parola:",validators = [
        validators.DataRequired(message = "Lütfen geçerli bir parola girin."),
...
def admin():
    ...
    if session["username"] == "xanny":
        ...
        flash("Bu alanı görmeye yetkiniz yok.","danger")
...
def register():
    ...
    if request.method == "POST" and form.validate():
        ...
        mysql.connection.commit() # refresh.
...
def deleteuser(id):
    if session["username"] == "xanny":
        ...
        """sorgu3 = "DELETE * FROM articles WHERE {{author.id}} = %s"
